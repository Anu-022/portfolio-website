        ...
        <section className="about ml-20 overflow-hidden">
            ...
            <div style={{width: '700px'}}>
                ...
                <div className="experience mt-5">
                    ...
                    <button onClick={handleOpenTraining}><i className='fa-solid fa-play text-sm'></i></button>
                    <span className='text-xl font-bold text-gray-800 pl-3'> Training</span>
                    <Training show={showTraining} />
                    <button onClick={handleOpenSkills}><i className='fa-solid fa-play text-sm'></i></button>
